...
const Modal = ({ children, onClose, tempModalStyles, containerStyles }: ModalProps) => {
    ...
    return (
        <div data-modal className={`absolute inset-0 flex items-center justify-center bg-gray-100/50 dark:bg-gray-950/70 backdrop-blur-[2px] pointer-events-none z-50 ${tempModalStyles}`} onKeyDown={(e) => e.key == "Escape" && onClose()}>
