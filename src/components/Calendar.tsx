                            ...
                            {monthNames.map((monthName, index) => {
                                ...
                                return (
                                    <button
                                        ...
                                        key={index}
                                        className={`${monthTotal > 100 ? "from-red-600 to-red-900" : monthTotal > 50 ? "from-yellow-400 to-yellow-600" : monthTotal > 19 ? "from-green-500 to-green-700" : "from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-900"} min-w-[6.55rem] md:w-40 flex flex-col items-center p-2 text-base md:text-2xl bg-gradient-to-tr rounded stdInt shadow-md bg-blue-400 ${themeSmooth}`}>
