...
const ReturnLink: React.FC<ReturnLinkProps> = ({ linkTo = "/", disabled = false }) => {
    ...
    const styles = `absolute max-md:bottom-1/3 max-md:right-8 md:top-3 md:left-8 px-7 py-1.5 ${borderStyles} text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 bg-white dark:bg-black ${shadowStyles} ${disabled ? "pointer-events-none" : `${hoverActiveAnim}`}`
